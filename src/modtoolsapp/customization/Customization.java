package modtoolsapp.customization;

public class Customization {
    //The String from the build.prop before the Version
    public static final String RO_MOD_START_STRING = "Mod_Tools_RLS";
    //Minimum Supported Version (So the User has to install google apps and so before)
    public static final String MIN_SUPPORTED_VERSION_STRING = RO_MOD_START_STRING + "1";
    ...
    //DB filename
    public static final String DATABASE_FILE = "modtools.db";
    //DownloadDirectory
    public static final String DOWNLOAD_DIR = "download";
    //MUST be the first package name.
    public static final String PACKAGE_FIRST_NAME = "modtoolsapp";
    //Filename for Instance save
    public static final String STORED_STATE_FILENAME = "modtools.state";
    //Android Board type
